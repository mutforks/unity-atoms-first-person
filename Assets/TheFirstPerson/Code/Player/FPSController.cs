...
public class FPSController : MonoBehaviour
{
    ...
    [Header("Options")]
    public BoolReference _extensionsEnabled;
    public bool extensionsEnabled => _extensionsEnabled.Value;
    public BoolReference _slopeSlideEnabled;
    public bool slopeSlideEnabled => _slopeSlideEnabled.Value;
    public BoolReference _sprintEnabled;
    public bool sprintEnabled => _sprintEnabled.Value;
    public BoolReference _momentumEnabled;
    public bool momentumEnabled => _momentumEnabled.Value;
    public BoolReference _crouchEnabled;
    public bool crouchEnabled => _crouchEnabled.Value;
    public BoolReference _jumpEnabled;
    public bool jumpEnabled => _jumpEnabled.Value;
    public BoolReference _verticalLookEnabled;
    public bool verticalLookEnabled => _verticalLookEnabled.Value;
    ...
    public FloatReference _jumpSpeed;
    public float jumpSpeed => _jumpSpeed.Value;
    [ConditionalHide("jumpEnabled", true)]
    ...
    public FloatReference _gravity;
    public float gravity => _gravity.Value;
    ...
    private float moveSpeed => _moveSpeed.Value;
    ...
    public FloatReference _sensitivity;
